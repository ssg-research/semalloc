...
readonly alloc_all="sys dh ff fg gd hd hm hml iso je lf lp lt mi mi-sec mi2 mi2-sec mng mesh nomesh pa rp sc scudo sg sm sn sn-sec tbb tc tcg mi-dbg mi2-dbg xmi xsmi xmi-dbg glibc css"
...
readonly tests_all1="cfrac espresso barnes lean larson-sized mstress rptest" # remove redis here as the script is not correct
...
alloc_lib_add "glibc"   " "
alloc_lib_add "css"     "/app/semalloc/backend/build/lib/libsemalloc.so"
